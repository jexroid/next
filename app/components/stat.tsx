...
function Stat() {
  return (
    <>
      <div className="stats shadow-md shadow-black my-5">
        <div className="stat">
      ...
      <div className="my-3">
        <Image src={ai} alt="profile of user" width={55} className="" />
        <div className="flex justify-center">
          {/* TODO: if the name was larger that made it to get out of the box, make a if statment to have ... from that above */}
          <div className="flex gap-2">
            <h3 className="text-lg">امیررضا فرزان</h3>
            <svg
              width={25}
              viewBox="0 0 48 48"
